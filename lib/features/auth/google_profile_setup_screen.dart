...
/// This screen is shown to Google sign-in users who don't yet have
/// a complete profile (username, college, location).
...
class _GoogleProfileSetupScreenState extends ConsumerState<GoogleProfileSetupScreen> {
  ...
  final _collegeDisplayController = TextEditingController();
  ...
  Future<void> _handleSave() async {
    ...
    if (_selectedState == null || _selectedDistrict == null || _selectedTaluka == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please select State, District, and Taluka')),
      );
      return;
    }
    ...
    try {
      ...
      if (!available) {
        if (mounted) {
          ...
          setState(() { _isLoading = false; _usernameAvailable = false; });
        }
        return;
      }

      // Update user profile with all the collected info
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Set up your username and college to get started with StudySphere.',
